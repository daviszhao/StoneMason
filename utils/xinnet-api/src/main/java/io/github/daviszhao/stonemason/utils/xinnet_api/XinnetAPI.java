package io.github.daviszhao.stonemason.utils.xinnet_api;
...
public class XinnetAPI {
    ...
    public String inpour(String agentCode, String type, String bank, final double amount) {
        log.debug("向平台充值");
        assert hasText(agentCode);
        assert XinnetAPI.ALIPAY.equals(type) || XinnetAPI.WEIXINPAY.equals(type);
        assert amount > 0;
        ...
        if (XinnetAPI.ALIPAY.equals(type) && hasText(bank))
