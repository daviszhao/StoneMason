...
public class NotifyEventPublishRecord extends UpdatableRecordImpl<NotifyEventPublishRecord> implements Record8<Integer, EventPayload, ProcessStatus, String, Integer, String, LocalDateTime, LocalDateTime> {
     ...
     */
    public NotifyEventPublishRecord(Integer id, EventPayload payload, ProcessStatus status, String eventid, Integer version, String eventtype, LocalDateTime createtime, LocalDateTime updatetime) {
        super(NotifyEventPublishTable.NOTIFY_EVENT_PUBLISH);
     ...
     */
    @Override
    public Row8<Integer, EventPayload, ProcessStatus, String, Integer, String, LocalDateTime, LocalDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, EventPayload, ProcessStatus, String, Integer, String, LocalDateTime, LocalDateTime> valuesRow() {
     ...
     */
    @Override
    public NotifyEventPublishRecord value2(EventPayload value) {
        setPayload(value);
        return this;
    }
     ...
     */
    @Override
    public NotifyEventPublishRecord values(Integer value1, EventPayload value2, ProcessStatus value3, String value4, Integer value5, String value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
